...
// Remove the current page from the menu items array
if (isset($menu_items[$current_page])) {
    unset($menu_items[$current_page]);
}
            ...
            <header id="header">
                <div class="top-bar">
                    <div class="inner jus-ct">
                        <p class="clr-pri-1">Working Hours : Monday - Friday, 12:00 pm - 05:00 pm || Saturday & Sunday, 10:00 am - 03:00 pm</p>
                    </div>
                </div>
                <div id="site-header">
                                        ...
                                        <nav id="mainnav" class="mainnav st-2">
                                            <ul class="menu">
                                                ...
                                                foreach ($menu_items as $label => $url) {
                                                    if ($url != $current_page) { // Check if the URL is not equal to the current page
                                        ...
                                        <div class="header-contact fx">
                                            ...
                                            <div class="inner-contact fx">
                                                ...
                                                <ul>
                                                    ...
                                                    <li class="clr-pri-2">+234(0) 803 276 1556</li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <ul class="list-news">
                                        <li class="fx">
                                            ...
                                            <ul class="box-content">
                                                <li>
                                                    <h6 class="title"><a href="blog-single.html">Bake Layers Accesilit Testing Supporte</a></h6>
                                                </li>
                                        ...
                                        <li class="fx">
                                            ...
                                            <ul class="box-content">
                                                <li>
                                                    <h6 class="title"><a href="blog-single.html">Bake Layers Accesilit Testin Supporte</a></h6>
                                                </li>
                                                <li><a href="blog-single.html" class="fx meta-news clr-pri-4"><i class="far fa-calendar-alt"></i><span class="f-rubik">25 nov 2021</span></a></li>
                                            </ul>
                                        </li>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title inner">
                                <?php echo "<h1 class='title'>$pageName</h1>"; ?>
                                <div class="breadcrumbs">
                                    <ul class="jus-ct">
                                        <li><a href="index.html" class="f-rubik">Home</a></li>
                                        <li>
                                            <p class="breadcrumbs-inner f-rubik"><?php echo $pageName; ?></p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
