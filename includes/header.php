                  ...
                  <div class="top-bar-2 fx">
                      ...
                      <div class="header-contact fx">
                          <div class="inner-contact fx">
                              ...
                              <ul>
                                  <li class="clr-pri-4">Our Location</li>
                                  <li class="clr-pri-2">3 Plerooville Crescent, Bye-Pass, Karshi, Nassarawa Nigeria</li>
                              </ul>
                          </div>
                  ...
                  <div class="site-header-inner st-2 fx">
                      ...
                      <div class="nav-wrap">
                          <nav id="mainnav" class="mainnav st-2">
                              <ul class="menu">
                                  <li class="inner <?php echo (basename($_SERVER['PHP_SELF']) == 'index.php') ? 'current-menu-item' : ''; ?>">
                                  ...
                                  <li class="inner">
                                      <a href="contact.html">OPPORTUNITIES</a>
                                  </li>
                                  <li class="inner">
              ...
              <div class="wrap">
                  <div class="widget widget-quote">
                      ...
                      <div class="box-content">
                          <h5 class="author clr-pri-2"> Mr Paul</h5>
